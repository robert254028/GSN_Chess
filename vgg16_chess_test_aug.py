...
models = []
models.append(load_model('aug_none.h5'))
models.append(load_model('aug_rot.h5'))
models.append(load_model('aug_rot_zoom.h5'))
models.append(load_model('aug_rot_zoom_hor.h5'))
models.append(load_model('aug_rot_zoom_hor_vert.h5'))
...
custom_labels = ['No augmentation', 'rot = 20', 'rot = 20, zoom = 0.2', 'rot = 20, zoom = 0.2\nhorizontal flip', 'rot = 20, zoom = 0.2\nhorizontal flip, vertical flip']

ax.set_yticklabels([f'{int(y*100)}' for y in ax.get_yticks()])

ax.set_ylabel('Dokładność klasyfikacji [%]', fontsize = 10, fontweight = 'bold')
ax.set_title('Dokładności modeli z augmentacją danych\n(Learning rate = 0.0005, momentum = 0.9, 15 epok)', fontsize = 14, fontweight = 'bold')
